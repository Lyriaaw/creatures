...
set_target_properties(mongo::mongocxx_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmongocxx.3.6.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libmongocxx._noabi.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS mongo::mongocxx_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_mongo::mongocxx_shared "${_IMPORT_PREFIX}/lib/libmongocxx.3.6.2.dylib" )
