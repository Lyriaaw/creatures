...
set_target_properties(mongo::bsoncxx_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libbsoncxx.3.6.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libbsoncxx._noabi.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS mongo::bsoncxx_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_mongo::bsoncxx_shared "${_IMPORT_PREFIX}/lib/libbsoncxx.3.6.2.dylib" )
