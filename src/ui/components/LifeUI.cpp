...
//
    ...
    float energyRatio = (life->getEnergyCenter()->getAvailableEnergy() / life->getEnergyCenter()->getMaxMass()) * energyDistance;
    ...
    std::string energyText = std::to_string(life->getEnergyCenter()->getAvailableEnergy());
